...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xffF6921f);
  ...
  static const Color grad1Color = Color(0xffF6921f);
  static const Color grad2Color = Color(0xffF6921f);
  static const Color lightWhite2 = Color(0xffEEF2F3);

  static const Color yellow = Color(0xfffdd901);

  static const Color red = Color(0xffF6921f);
