...
import 'package:Jumanzee/Model/User.dart';
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    List<Product_Varient> prVarientList = (json[PRODUCT_VARIENT] as List)
        .map((data) => new Product_Varient.fromJson(data))
        .toList();

    List<Varients> varientsList = (json["variants"] as List)
        .map((data) => new Varients.fromJson(data))
        .toList();
