...
import 'package:Jumanzee/Provider/ProductDetailProvider.dart';
import 'package:Jumanzee/Provider/UserProvider.dart';
import 'package:Jumanzee/Screen/Cart.dart';
import 'package:Jumanzee/Screen/CompareList.dart';
import 'package:Jumanzee/Screen/ProductList.dart';
import 'package:Jumanzee/Screen/ReviewList.dart';
...
/*  _transactionscrollListener() {
  ...
  _getVarient(int? pos) {
    if (widget.model!.type == "variable_product") {
      ...
      // if(widget.model!.varients![widget.model!.selVarient!].varient_value != null){
      //
      // }
        ...
        try {
          ...
          if (int.parse(qty) < model.minOrderQuntity!) {
            ...
            Fluttertoast.showToast(
              msg: '${getTranslated(context, 'MIN_MSG')}$qty',
