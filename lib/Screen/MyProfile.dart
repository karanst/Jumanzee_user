...
import 'package:Jumanzee/Screen/Customer_Support.dart';
import 'package:Jumanzee/Screen/MyTransactions.dart';
import 'package:Jumanzee/Screen/ReferEarn.dart';
import 'package:Jumanzee/Screen/SendOtp.dart';
import 'package:Jumanzee/Screen/Setting.dart';
                  ...
                  ? FutureBuilder(
                      ...
                      builder: (BuildContext context, AsyncSnapshot snapshot) {
                        if (snapshot.hasData) {
                          ...
                          print("Profile Data ========================> $imageUrl${data[0].proPic}");
                          return data[0].proPic != null
                              ? Image.network("$imageUrl${data[0].proPic}")
